...
| | Corrida 1 | Corrida 2 |
|---|---|---|
| Ejecución | `20260923-133615` | `20260923-133705` |
| Inicio | 2026-09-23 13:36:09 | 2026-09-23 13:37:05 |
| Duración | 55.9 s | 48.1 s |
| Tablas medidas | 52 | 52 |
| Filas totales | 9,080,860 | 9,080,860 |

**Resultado: IDEMPOTENTE**

| Capa | Tabla | Filas corrida 1 | Filas corrida 2 | Huella corrida 1 | Huella corrida 2 | Igual |
|---|---|---:|---:|---|---|---|
| bronze | aerometro_boardings | 203,554 | 203,554 | `773b50dbcfac5350` | `773b50dbcfac5350` | sí |
...
| bronze | transmetro_validaciones | 363,221 | 363,221 | `d78d0659ef592b40` | `d78d0659ef592b40` | sí |
...
| silver | am_boardings_evaluado | 203,554 | 203,554 | `dfd81c4d02417b13` | `dfd81c4d02417b13` | sí |
| silver | am_cuarentena | 0 | 0 | `vacia` | `vacia` | sí |
...
| silver | cuarentena | 12,475 | 12,475 | `c38bbefa3fe4568f` | `c38bbefa3fe4568f` | sí |
...
| silver | dim_persona | 70,380 | 70,380 | `8da04b270184d7fa` | `8da04b270184d7fa` | sí |
...
| silver | slv_am_abordajes | 203,554 | 203,554 | `2de2d239ed55ace0` | `2de2d239ed55ace0` | sí |
...
| silver | slv_tm_abordajes | 362,106 | 362,106 | `033e5cbe0930b283` | `033e5cbe0930b283` | sí |
...
| silver | tm_cuarentena | 1,115 | 1,115 | `fefa05e655310532` | `fefa05e655310532` | sí |
| silver | tm_validaciones_evaluado | 363,221 | 363,221 | `9a943892b6463b90` | `9a943892b6463b90` | sí |
...
| silver | usuarios_aerometro | 14,496 | 14,496 | `7ca6c499c3440f87` | `7ca6c499c3440f87` | sí |
...
| gold | dim_persona | 70,380 | 70,380 | `369f542e1ad9776b` | `369f542e1ad9776b` | sí |
| gold | dim_zona | 16 | 16 | `ae65f3ebd54498ee` | `ae65f3ebd54498ee` | sí |
| gold | fct_abordaje | 1,651,158 | 1,651,158 | `d1d43d411f76fdef` | `d1d43d411f76fdef` | sí |
...
| features | features_persona | 70,380 | 70,380 | `41ab526295660714` | `41ab526295660714` | sí |
| reportes | cat_reglas_calidad | 43 | 43 | `bb3a1e9250c3f709` | `bb3a1e9250c3f709` | sí |
| reportes | rpt_calidad | 43 | 43 | `a156d846e3dd3278` | `a156d846e3dd3278` | sí |
| reportes | rpt_volumen_por_capa | 4 | 4 | `eebf0cadbe41b4ab` | `eebf0cadbe41b4ab` | sí |
